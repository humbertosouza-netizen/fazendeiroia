...
import { Loader2, ArrowLeft, Tractor, Wheat, Leaf, Trees, ChevronRight } from "lucide-react";
import anunciosService, { Anuncio } from "@/services/anunciosService";
import AiBuscaFazenda from "@/components/AiBuscaFazenda";
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white to-gray-50">
      ...
      <header className="bg-white bg-opacity-80 backdrop-blur-md border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto py-3 px-3 sm:py-4 sm:px-6 lg:px-8 flex flex-wrap justify-between items-center gap-2">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 flex items-center">
                <span className="bg-gradient-to-r from-green-600 to-green-800 text-transparent bg-clip-text">Fazendeiro</span>
                <span className="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gradient-to-r from-green-500 to-green-700 text-white">
                  AI
                </span>
              </h1>
          ...
          <Link href="/login">
            <Button variant="outline" size="sm" className="border-green-600 text-green-700 hover:bg-green-50 text-sm whitespace-nowrap">Área do Anunciante</Button>
          </Link>
        </div>
      </header>
        ...
        {carregando ? (
          ...
          <div className="flex-1 flex flex-col">
                ...
                <div className="max-w-2xl relative z-10">
                  ...
                  <div className="mt-5 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        <p className="font-medium text-white">Recomendações em tempo real</p>
                        <p className="mt-1 text-green-100 opacity-80">Veja as melhores opções durante a conversa</p>
                      </div>
                    </div>
                  ...
                  <div className="mt-6 sm:mt-8 flex flex-wrap gap-3 sm:gap-4 items-center">
                    <button
                      className="w-full sm:w-auto px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium rounded-lg bg-white text-green-800 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-green-800 shadow-sm"
                      onClick={() => {
                        const chatInput = document.querySelector('input[placeholder*="Descreva"]') as HTMLInputElement;
                        if (chatInput) {
                          chatInput.focus();
                        }
                      }}
                    ...
                    <a href="#sobre" className="text-xs sm:text-sm font-medium text-green-200 hover:text-white flex items-center">
            ...
            <div className="flex-1 bg-gray-50">
              <AiBuscaFazenda anuncios={anuncios} />
            </div>
          </div>
        )}
      </main>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-1 gap-4 sm:gap-0">
              <div>
                ...
                <ul className="space-y-2 sm:space-y-3">
                  ...
                  <li>
                    <a href="#sobre" className="text-gray-300 hover:text-green-400 transition-colors flex items-center">
                      <ChevronRight className="h-3 w-3 mr-2 text-green-500" />
                      Sobre o Fazendeiro IA
                    </a>
                  </li>
